package com.project.eduapp.utils;
...
public class MessageKeys {
    ...
    public static final String UPLOAD_VIDEOS_MAX_LIMIT = "product.upload_images.error_max_5_images";
    public static final String UPLOAD_VIDEOS_FILE_LARGE = "product.upload_images.file_large";
    public static final String UPLOAD_VIDEOS_FILE_MUST_BE_VIDEO = "product.upload_images.file_must_be_image";
    ...
    public static final String CREATE_GAME_SUCCESS = "create.game.success";
    public static final String GET_GAMES_SUCCESS = "get.games.success";
    public static final String DELETE_GAME_SUCCESS = "delete.game.success";
}
