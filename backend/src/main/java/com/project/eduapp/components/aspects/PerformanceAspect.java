package com.project.eduapp.components.aspects;
...
public class PerformanceAspect {
    ...
    //@Pointcut("within(com.project.eduapp.controllers.*)")
    //@Pointcut("within(com.project.eduapp.controllers.CategoryController)")
